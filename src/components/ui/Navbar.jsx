      ...
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        <nav>
          <ul className="flex space-x-4">
            <li><NavLink to="/" className="text-gray-700 hover:text-gray-900">Inicio</NavLink></li>
            <li><NavLink to="/mytrips" className="text-gray-700 hover:text-gray-900">Mis viajes</NavLink></li>
          </ul>
        </nav>
      </div>
    </header>
